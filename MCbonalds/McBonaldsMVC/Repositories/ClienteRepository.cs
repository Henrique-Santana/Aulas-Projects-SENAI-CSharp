...
namespace McBonaldsMVC.Repositories
{
    public class ClienteRepository
    {
        ...
        public ClienteRepository()
            ...
            {
                return $"nome={cliente.Nome};7={cliente.Email};senha={cliente.Senha};endereço={cliente.Endereço};telefone{cliente.Telefone};dataNascimento={cliente.DataNascimento}";
            }
